    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="py-20 grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-10">
        ...
        <div className="relative flex items-center justify-center h-[400px]">
          {/* Image 1 - Top Right */}
          <div className="absolute top-0 right-0 w-64 h-64 rounded-2xl overflow-hidden border-2 border-foreground/20 shadow-lg">
            <Image 
              src="/images/abde.jpg" 
          ...
          {/* Image 2 - Bottom */}
          <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-64 h-64 rounded-2xl overflow-hidden border-2 border-foreground/20 shadow-lg">
            <Image 
      ...
      <div className="py-20 flex flex-col-reverse lg:grid lg:grid-cols-[2fr_1fr] gap-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Project Card 1 */}
          <a href="https://github.com/MRQ67/MarkPlainer" target="_blank" rel="noopener noreferrer" className="block">
          ...
          {/* Project Card 2 */}
          <a href="https://github.com/MRQ67/zync-chat" target="_blank" rel="noopener noreferrer" className="block">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl overflow-hidden border-2 border-foreground/20 hover:border-foreground/40 transition-all hover:shadow-xl shadow-md cursor-pointer">
          ...
          {/* Project Card 3 */}
          <a href="https://github.com/MRQ67/unique-e-learning" target="_blank" rel="noopener noreferrer" className="block">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl overflow-hidden border-2 border-foreground/20 hover:border-foreground/40 transition-all hover:shadow-xl shadow-md cursor-pointer">
          ...
          {/* Project Card 4 */}
          <a href="https://unique-validation.vercel.app/" target="_blank" rel="noopener noreferrer" className="block">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl overflow-hidden border-2 border-foreground/20 hover:border-foreground/40 transition-all hover:shadow-xl shadow-md cursor-pointer">
              <div className="h-60 relative">
                <Image 
      ...
      <div className="py-20 flex flex-col items-center justify-center">
        <h2 className="text-4xl md:text-6xl font-bold mb-12 text-center font-[family-name:var(--font-inter)]">
          Get in Touch
        </h2>
