...
export function ProjectCard({ project, index, useAnimate = false }: ProjectCardProps) {
  ...
  const CardContent = (
    <div className="group relative w-full mx-auto space-y-4">
      {/* Thumbnail - Floating */}
      <motion.div
      ...
      >
        ...
        {project.tags.length > 3 && (
          <span className="px-2.5 py-1 text-xs bg-secondary text-secondary-foreground rounded-full">
            +{project.tags.length - 3}
          </span>
        )}
      </motion.div>
      ...
      >
        {project.links.github && (
          <a
            ...
            className="px-3 py-1.5 text-xs bg-secondary hover:bg-secondary/80 text-secondary-foreground rounded-full border border-border transition-all duration-300 flex items-center gap-1"
          >
        ...
        {project.links.demo && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-3 py-1.5 text-xs bg-primary hover:bg-primary/90 text-primary-foreground rounded-full transition-all duration-300 flex items-center gap-1"
          >
        ...
        <Link
          ...
          className="px-3 py-1.5 text-xs bg-accent hover:bg-accent/80 text-accent-foreground rounded-full border border-border transition-all duration-300 flex items-center gap-1"
        >
          <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
